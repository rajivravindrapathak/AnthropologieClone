   ...
   useEffect(()=>{
    ...
    return (
        ...
        <div className='product'>
            <p className='p-head'>Search Results    {store} </p>
            <div id="sort">
...
<Link to="/clothing">Clothing</Link>
               ...
               {
                   productData.filter((product)=>product.title.toLowerCase().includes(`${store}`)).map((e,i)=>(
